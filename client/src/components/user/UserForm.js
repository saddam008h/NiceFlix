...
import girl from '../../assets/concept.svg'
  ...
  return (
    <div className="w-full min-h-screen flex justify-center items-center lg:mt-12  p-4 md:p-10 lg:p-12">
      ...
      <div className="w-full max-w-md md:max-w-4xl flex justify-center items-center">
        {/* Card Container */}
        <div className="w-full px-4 pt-4 pb-8 mb-24 bg-zinc-800 border border-gray-700 flex justify-center items-center gap-10 md:pb-24 md:mb-24 md:px-10 md:py-12 lg:px-12 lg:py-16 rounded-md">
          {/* Form  */}
          <div className="form-control w-full">
            ...
            <div className="form-control mt-6">
              {!registerLoading && page === "register" && (
                <button className="btn bg-yellow-700 hover:bg-yellow-800" onClick={handleSubmit}>
                  Register
                </button>
              )}
              {registerLoading && page === "register" && (
                <button className="btn btn-active  bg-yellow-700 hover:bg-yellow-800 loading btn-disabled">
                  Registering
                </button>
              )}
